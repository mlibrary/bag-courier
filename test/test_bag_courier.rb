...
class BagIdTest < Minitest::Test
  def test_to_s
    ...
    assert_equal expected, BagCourier::BagId.new(
      repository: "somerepo", digital_object_id: "uniqueid"
    ).to_s
  end
  ...
  def test_to_s_with_context
    ...
    assert_equal expected, BagCourier::BagId.new(
      repository: "somerepo", digital_object_id: "uniqueid", context: "somecontext"
    ).to_s
  end
  ...
  def test_to_s_with_part
    ...
    assert_equal expected, BagCourier::BagId.new(
      repository: "somerepo", digital_object_id: "uniqueid", part_id: "4"
    ).to_s
  end
...
class BagCourierTest < SequelTestCase
  def setup
    ...
    @bag_repo.create(
      identifier: @bag_id.to_s,
      group_part: 1,
      repository_package_identifier: @digital_object_id
    )
  end
